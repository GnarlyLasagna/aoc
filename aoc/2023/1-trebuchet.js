...
function numberFinder(input){ // version 1
    let ans = 0
    let nums = []
    let arr = input.split('\n')
...
// console.log("test final result ",numberFinder(testInput))
console.log("test second result ",secondNumberFinder(secondTest))

const realInput = `six1mpffbnbnnlxthree
4eight3one92
9nine2xnhvjtjlzj48
...
console.log("real final result ",numberFinder(realInput))
console.log("second real final result ",secondNumberFinder(realInput))
