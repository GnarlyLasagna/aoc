...
function parabolicReflectorDisk(input){
input = input.split("\n")
...
function parabolicReflectorDiskTwo(input){
input = input.split("\n")
...
parabolicReflectorDisk(testInput)
parabolicReflectorDiskTwo(testInput)

const realInput = `#..O.#..#...##O..O.......O.#..#.O#.#.....#O.#.O..#OO....O..O..O.OO....O.O#.O..........#....OOO..O##O
...
parabolicReflectorDisk(realInput)
parabolicReflectorDiskTwo(realInput)
